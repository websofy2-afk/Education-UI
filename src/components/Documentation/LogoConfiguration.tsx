export const LogoConfiguration = () => {
    return (
        <>
            <h3 className="  text-xl font-semibold mt-8 dark:text-white text-MidnightNavyText" >Logo</h3>
            <div className="p-6 rounded-md border mt-4 border-border dark:border-dark_border">
                <p className="text-base font-medium text-SlateBlueText dark:text-opacity-80 flex lg:flex-row flex-col" >1. Change Logo over here : <span className="font-semibold text-base overflow-x-auto">src/components/Layout/Header/Logo/index.tsx</span>  </p>
  ...
  <p>/&#x3E;</p>
  <p className="ms-2">&#x3C;Image</p>
    <p className="ms-5">src=&#x22;/images/footer/footer-logo-white.svg&#x22;</p>
